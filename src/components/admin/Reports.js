...
const Reports = () => {
  ...
  useEffect(() => {
    const sampleData = {
      playerPerformance: [
        { name: 'Maneendra Jayathilaka', runs: 1250, wickets: 5, matches: 15, average: 45.2, strikeRate: 125.5 },
        { name: 'Monil Jason', runs: 890, wickets: 28, matches: 12, average: 32.1, strikeRate: 98.3 },
        { name: 'Dilhara Polgampola', runs: 1100, wickets: 15, matches: 18, average: 38.9, strikeRate: 112.4 },
        { name: 'Lahiru Abhesinghe', runs: 750, wickets: 8, matches: 14, average: 28.6, strikeRate: 105.2 },
        { name: 'Asitha Wanninayaka', runs: 650, wickets: 2, matches: 16, average: 25.0, strikeRate: 95.8 },
        { name: 'Suviru Sathnidu', runs: 720, wickets: 6, matches: 14, average: 36.4, strikeRate: 118.0 },
        { name: 'Kavisha Weerasinghe', runs: 810, wickets: 0, matches: 13, average: 40.5, strikeRate: 130.2 },
        { name: 'Chamod Hasalanka', runs: 930, wickets: 1, matches: 16, average: 41.8, strikeRate: 127.6 },
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200">
        ...
        <div className="p-6">
          ...
          {activeReport === 'player-performance' && (
            <div className="space-y-6">
              <div className="flex justify-between items-center">
                <h3 className="text-lg font-medium text-gray-900">Player Performance Report</h3>
                <button
                  ...
                  {reportData.playerPerformance?.slice(0, 5).map((player, index) => (
                    <div key={player.name} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                      ...
                      <div className="text-right">
                        <p className="text-sm font-medium text-gray-900">{player.runs} runs</p>
                ...
                <table className="min-w-full divide-y divide-gray-200">
                  <thead className="bg-gray-50">
                    <tr>
                      ...
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Strike Rate</th>
                    </tr>
                  </thead>
          ...
          {activeReport === 'team-season' && (
            <div className="space-y-6">
              <div className="flex justify-between items-center">
                <h3 className="text-lg font-medium text-gray-900">Team Season Report</h3>
                <button
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg p-6 text-white">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold">{reportData.teamSeason?.totalMatches}</p>
                    </div>
                ...
                <div className="bg-gradient-to-r from-green-500 to-green-600 rounded-lg p-6 text-white">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-green-100 text-sm">Win Percentage</p>
                      <p className="text-2xl font-bold">{reportData.teamSeason?.winPercentage}%</p>
                    </div>
                ...
                <div className="bg-gradient-to-r from-purple-500 to-purple-600 rounded-lg p-6 text-white">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-purple-100 text-sm">Total Runs</p>
                      <p className="text-2xl font-bold">{reportData.teamSeason?.totalRuns?.toLocaleString()}</p>
                    </div>
                ...
                <div className="bg-gradient-to-r from-orange-500 to-orange-600 rounded-lg p-6 text-white">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-orange-100 text-sm">Total Wickets</p>
                      <p className="text-2xl font-bold">{reportData.teamSeason?.totalWickets}</p>
                    </div>
          ...
          {activeReport === 'fitness-injury' && (
            <div className="space-y-6">
              <div className="flex justify-between items-center">
                <h3 className="text-lg font-medium text-gray-900">Fitness & Injury Report</h3>
                <button
